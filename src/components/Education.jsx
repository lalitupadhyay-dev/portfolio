...
const EducationCard = (props) => {
    ...
    return(
        <motion.div ref={ref} className="flex flex-col mx-2 border border-purple-300/50 p-4 my-4 rounded-md" initial="hidden" animate={controls} variants={{hidden: {opacity: 0, y: 100}, visible: {opacity: 1, y: 0}}} transition={{duration: 0.8, ease: "easeOut"}}>
